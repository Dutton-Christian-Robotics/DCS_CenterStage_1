...
public class SBBMecanumDrivetrain extends DefenderBotDrivetrain {

    public DcMotorEx backLeft, frontLeft, frontRight, backRight;


    public SBBMecanumDrivetrain(HardwareMap hm, DefenderBot b) {
	   super(hm, b);

	   backLeft = hm.get(DcMotorEx.class, SBBConfiguration.DRIVETRAIN_BACKLEFT_MOTOR_NAME);
	   frontLeft = hm.get(DcMotorEx.class, SBBConfiguration.DRIVETRAIN_FRONTLEFT_MOTOR_NAME);
	   frontRight = hm.get(DcMotorEx.class, SBBConfiguration.DRIVETRAIN_FRONTRIGHT_MOTOR_NAME);
	   backRight = hm.get(DcMotorEx.class, SBBConfiguration.DRIVETRAIN_BACKRIGHT_MOTOR_NAME);

	   backLeft.setDirection(SBBConfiguration.DRIVETRAIN_BACKLEFT_MOTOR_DIRECTION);
	   frontLeft.setDirection(SBBConfiguration.DRIVETRAIN_FRONTLEFT_MOTOR_DIRECTION);
	   frontRight.setDirection(SBBConfiguration.DRIVETRAIN_FRONTRIGHT_MOTOR_DIRECTION);
	   backRight.setDirection(SBBConfiguration.DRIVETRAIN_BACKRIGHT_MOTOR_DIRECTION);
    ...
    private void setProportionalPower(double bl, double fl, double fr, double br) {
	   double largest = SBBConfiguration.DRIVETRAIN_POWER_MAX;
...
//			 DcMotorSimple.Direction.REVERSE, DcMotorSimple.Direction.REVERSE);
	   ...
	   double maxTicksSecond = SBBConfiguration.DRIVETRAIN_MAX_TICKS_PER_SECOND;
