...
public class SBBOldNavigation extends DefenderBotSystem {
    ...
    public SBBOldNavigation(HardwareMap hm, DefenderBot b) {
	   super(hm, b);
...
//	   backRight = ((ProductionBotMecanumDrivetrain) bot.drivetrain).backRight;
    ...
    public void comeToRelativeHeading(double angle, double maxPower, double tolerance, double timeout) {
	   double startingAngle = Math.floor(sensors.getAngle());
	   ...
	   double power;
	   do {
		  currentAngle = Math.floor(sensors.getAngle());
